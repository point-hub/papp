  ...
  <Demo>
    <component :is="BaseTreeview" :is-open="true">
      <template #header="slotProps">
        <component :is="BaseIcon" v-if="!slotProps.isOpen" icon="i-far-folder" class="w-4 h-4" />
        <component
          :is="BaseIcon"
          v-if="slotProps.isOpen"
          icon="i-far-folder-open"
          class="w-4 h-4"
        />
      ...
      <component :is="BaseTreeview" :is-open="true">
        ...
        <button class="btn btn-block space-x-4">
          <component :is="BaseIcon" icon="i-far-file-lines" class="w-4 h-4" />
