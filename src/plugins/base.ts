...
export default {
  install(Vue: App) {
    ...
    Vue.component('BaseAccordionItem', BaseAccordionItem)
    ...
    Vue.component('BaseDropdownItem', BaseDropdownItem)
    ...
    Vue.component('BaseTabGroup', BaseTabGroup)
    Vue.component('BaseTabList', BaseTabList)
    Vue.component('BaseTabPanel', BaseTabPanel)
    Vue.component('BaseTabPanels', BaseTabPanels)
    Vue.component('BaseTable', BaseTable)
    Vue.component('BaseTextarea', BaseTextarea)
    Vue.component('BaseTimeline', BaseTimeline)
    Vue.component('BaseTimelineContent', BaseTimelineContent)
